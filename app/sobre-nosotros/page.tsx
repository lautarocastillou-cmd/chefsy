      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-5 text-sm font-semibold">
            <Link href="/" className="text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors cursor-pointer">Tienda</Link>
            <Link href="/sobre-nosotros" className="text-chefsy font-bold transition-colors cursor-pointer">Nosotros</Link>
          </nav>
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="bg-chefsy hover:bg-chefsy-600 text-white px-5 py-2 rounded-xl text-sm font-extrabold shadow-lg shadow-chefsy/30 active:scale-95 transition-all flex items-center gap-2">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4">
              <Link href="/" className="w-full sm:w-auto bg-chefsy hover:bg-chefsy-600 text-white px-8 py-4 rounded-2xl text-lg font-black shadow-xl shadow-chefsy/30 active:scale-95 transition-all flex items-center justify-center gap-2">
        ...
        <section id="destacados" className="py-24 px-4">
          <div className="max-w-6xl mx-auto space-y-12">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
              ...
              <Link href="/" className="text-chefsy font-bold hover:underline flex items-center gap-1">
              ...
              {productosDestacados.map(prod => (
                <div key={prod.id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-all group flex flex-col justify-between">
                  ...
                  <div className="p-6 pt-4">
                    <Link href="/" className="block w-full text-center bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold py-3.5 rounded-xl transition-colors text-sm">
                      Pedir ahora
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-chefsy text-white rounded-[3rem] p-10 md:p-16 text-center space-y-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="pt-4">
              <Link href="/" className="inline-flex bg-white text-chefsy px-10 py-4 rounded-2xl text-xl font-black hover:scale-105 active:scale-95 transition-all shadow-xl">
                Ir a la Tienda
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <Link href="/" className="hover:text-white transition-colors">Menú Online</Link>
