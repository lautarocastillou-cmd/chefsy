...
export default function PaginaStock() {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-8 max-w-[1400px] w-full mx-auto pb-24">
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-1.5 sm:mb-2">Control de Stock Inteligente</h1>
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
          Gestioná tus insumos, asigná recetas a tus productos y auditá todos los movimientos en el Kardex inmutable.
        </p>
      </div>

      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-5 gap-3 sm:gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 px-4 py-2 rounded-xl text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm shrink-0 cursor-pointer"
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-3 sm:p-5 md:p-6 min-h-[500px] shadow-sm">
        {tabActivo === 'categorias' && (
