...
export default function BotonWhatsAppHeader({ size = 'md' }: BotonWhatsAppHeaderProps) {
  ...
  return (
    ...
    >
      {/* Icono oficial de WhatsApp con teléfono blanco y burbuja verde */}
      <svg
        className="group-hover:scale-110 transition-transform duration-200 shrink-0 drop-shadow-sm"
        style={{ width: size === 'sm' ? '15px' : '17px', height: size === 'sm' ? '15px' : '17px' }}
        viewBox="0 0 175.216 175.552"
        xmlns="http://www.w3.org/2000/svg"
      >
        <defs>
          <linearGradient id="waGradHeader" x1="85.915" x2="86.535" y1="32.567" y2="137.092" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#2fe664" />
            <stop offset="1" stopColor="#1caa36" />
          </linearGradient>
        </defs>
        {/* Contorno blanco nítido para fondos oscuros */}
        <path
          fill="#ffffff"
          d="m12.966 161.238 10.439-38.114a73.42 73.42 0 0 1-9.821-36.772c.017-40.556 33.021-73.55 73.578-73.55 19.681.01 38.154 7.669 52.047 21.572s21.537 32.383 21.53 52.037c-.018 40.553-33.027 73.553-73.578 73.553h-.032c-12.313-.005-24.412-3.094-35.159-8.954z"
        />
        {/* Burbuja verde oficial de WhatsApp */}
        <path
          fill="url(#waGradHeader)"
